...
while continuar:
    ...
    print('2 - Cambiar fecha de nacimiento')
    print('3 - Cambiar numero de amigos')
    print('4 - Salir')
    opcion = int(input())
    ...
    #Así, en la siguiente iteración el ciclo terminará
       ...
       agno = input('Escribe tu nueva fecha de nacimiento:')
       print('Tu nueva fecha de nacimiento es:', agno)
    elif opcion == 3:
        num_amigos
    elif opcion == 4:
        continuar = False
