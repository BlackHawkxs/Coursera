...
numero = input('Tu numero de telefono. ')
ciudad = input('Y la ciudad en la que vives. ')
if ciudad == "Montevideo" or ciudad == "montevideo":
    print("Montevideo es una linda ciudad")
